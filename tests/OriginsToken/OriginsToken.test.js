...
const { shouldBehaveLikeERC20, shouldBehaveLikeERC20Transfer, shouldBehaveLikeERC20Approve } = require("../ERC20.behavior");

const ERC20Mock = artifacts.require("OriginsToken");

contract("ERC20", function (accounts) {
	const [initialHolder, recipient, anotherAccount] = accounts;

	const name = "Sovryn Origins";
	const symbol = "OG";
	const decimal = "18";

	const initialSupply = new BN(1);
	...
	describe("_burn", function () {
		it("rejects a null account", async function () {
			await expectRevert(this.token.burn(ZERO_ADDRESS, new BN(1)), "OriginsToken: Not Allowed");
		});
