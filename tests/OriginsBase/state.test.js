 ...
 * Checks Tier Details.
 */
async function checkTier(_originsBase, _tierCount, _minAmount, _maxAmount, _remainingTokens, _saleStartTS, _saleEnd, _unlockedTokenWithdrawTS, _unlockedBP, _vestOrLockCliff, _vestOrLockDuration, _depositRate, _depositToken, _depositType, _verificationType, _saleEndDurationOrTS, _transferType) {
...
contract("OriginsBase (State Functions)", (accounts) => {
    ...
    it("Adding a new tier should update the state correctly.", async () => {
        ...
        await originsBase.createTier(firstMaxAmount, firstRemainingTokens, firstSaleStartTS, firstSaleEnd, firstUnlockedBP, firstVestOrLockCliff, firstVestOfLockDuration, firstDepositRate, firstDepositType, firstVerificationType, firstSaleEndDurationOrTS, firstTransferType, { from: owner });
        tierCount = await originsBase.getTierCount();
        await checkTier(originsBase, tierCount, zero, firstMaxAmount, firstRemainingTokens, firstSaleStartTS, firstSaleEnd, zero, firstUnlockedBP, firstVestOrLockCliff, firstVestOfLockDuration, firstDepositRate, firstDepositToken, firstDepositType, firstVerificationType, firstSaleEndDurationOrTS, firstTransferType);
    });
    ...
    it("Owner should be able to set Tier Verification Parameters.", async () => {
        ...
        await checkTier(originsBase, tierCount, zero, firstMaxAmount, firstRemainingTokens, firstSaleStartTS, firstSaleEnd, zero, firstUnlockedBP, firstVestOrLockCliff, firstVestOfLockDuration, firstDepositRate, firstDepositToken, firstDepositType, secondVerificationType, firstSaleEndDurationOrTS, firstTransferType);
    });
    ...
    it("Owner should be able to set Tier Deposit Parameters.", async () => {
        ...
        await checkTier(originsBase, tierCount, zero, firstMaxAmount, firstRemainingTokens, firstSaleStartTS, firstSaleEnd, zero, firstUnlockedBP, firstVestOrLockCliff, firstVestOfLockDuration, secondDepositRate, secondDepositToken, firstDepositType, firstVerificationType, firstSaleEndDurationOrTS, firstTransferType);
    });
    ...
    it("Owner should be able to set Tier Token Limit Parameters.", async () => {
        ...
        await checkTier(originsBase, tierCount, secondMinAmount, secondMaxAmount, firstRemainingTokens, firstSaleStartTS, firstSaleEnd, zero, firstUnlockedBP, firstVestOrLockCliff, firstVestOfLockDuration, firstDepositRate, firstDepositToken, firstDepositType, firstVerificationType, firstSaleEndDurationOrTS, firstTransferType);
    });
    ...
    it("Owner should be able to set Tier Token Amount Parameters.", async () => {
        ...
        await checkTier(originsBase, tierCount, zero, firstMaxAmount, secondRemainingTokens, firstSaleStartTS, firstSaleEnd, zero, firstUnlockedBP, firstVestOrLockCliff, firstVestOfLockDuration, firstDepositRate, firstDepositToken, firstDepositType, firstVerificationType, firstSaleEndDurationOrTS, firstTransferType);
    });
    ...
    it("Owner should be able to set Tier Vest or Lock Parameters.", async () => {
        ...
        await originsBase.createTier(firstMaxAmount, firstRemainingTokens, firstSaleStartTS, firstSaleEnd, firstUnlockedBP, firstVestOrLockCliff, firstVestOfLockDuration, firstDepositRate, firstDepositType, firstVerificationType, firstSaleEndDurationOrTS, firstTransferType, { from: owner });
        tierCount = await originsBase.getTierCount();
        await originsBase.setTierVestOrLock(tierCount, secondVestOrLockCliff, secondVestOfLockDuration, waitedTS, secondUnlockedBP, secondTransferType, { from: owner });
        await checkTier(originsBase, tierCount, zero, firstMaxAmount, firstRemainingTokens, firstSaleStartTS, firstSaleEnd, waitedTS, secondUnlockedBP, secondVestOrLockCliff, secondVestOfLockDuration, firstDepositRate, firstDepositToken, firstDepositType, firstVerificationType, firstSaleEndDurationOrTS, secondTransferType);
    });
    ...
    it("Owner should be able to set Tier Time Parameters.", async () => {
        ...
        await checkTier(originsBase, tierCount, zero, firstMaxAmount, firstRemainingTokens, secondSaleStartTS, secondSaleEnd, zero, firstUnlockedBP, firstVestOrLockCliff, firstVestOfLockDuration, firstDepositRate, firstDepositToken, firstDepositType, firstVerificationType, secondSaleEndDurationOrTS, firstTransferType);
    });
    ...
    it("Verifier should be able to verify a multiple address to a multiple tier.", async () => {
        ...
        await originsBase.createTier(firstMaxAmount, firstRemainingTokens, firstSaleStartTS, firstSaleEnd, firstUnlockedBP, firstVestOrLockCliff, firstVestOfLockDuration, firstDepositRate, firstDepositType, firstVerificationType, firstSaleEndDurationOrTS, firstTransferType, { from: owner });
        tierCount = await originsBase.getTierCount();
        await originsBase.multipleAddressAndTierVerification([userOne, userTwo, userThree], [tierCount, tierCount-1, tierCount-2], { from: verifier });
        let currentStatus = await originsBase.isAddressApproved(userOne, tierCount);
        assert.strictEqual(currentStatus, true, "Address Verification invalid");
